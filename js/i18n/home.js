export const home = {
  ...
  fr: {
    ...
    'beyond.games.text': "Je développe de petits jeux sur mon temps libre. C'est là que je fais les parties de l'ingénierie que le travail en production ne permet pas : physique, génération procédurale, et chercher ce qu'une mécanique procure plutôt que de savoir si elle passe à l'échelle.",
    ...
    'work.optimops.title': 'OptimOps Neo',
    'work.optimops.summary': "Une plateforme d'aide à la décision pour un service d'incendie et de secours français : analyse de couverture, simulation de scénarios et optimisation des ressources, restituées dans un tableau de bord que les utilisateurs configurent eux-mêmes, via une API adossée à des fichiers Parquet.",
    ...
    'work.kpi-engine.summary': "Une reconstruction complète du moteur d'indicateurs d'OptimOps — un contrat d'entrée validé, un noyau structuré en schéma en étoile, et un harnais de non-régression qui vérifie chaque valeur face au moteur qu'il remplace.",
    'work.emotion-recognition.role': 'Stage de recherche',
    'work.emotion-recognition.year': '2023',
    'work.emotion-recognition.title': 'Reconnaissance multimodale des émotions',
    'work.emotion-recognition.summary': "Reconnaissance des émotions sur vidéo, texte, audio et images à l'université de Portsmouth — ajustement fin de DeBERTa et d'un modèle OpenAI, avec un outil de transcription en direct pour l'analyse en temps réel.",
    'work.predictops.role': 'Prévision · dataviz',
    'work.predictops.year': '2023 — 2024',
    'work.predictops.title': 'Predictops',
    'work.predictops.summary': "Prévision géolocalisée des interventions de secours, en combinant des données opérationnelles historiques et des signaux météo, restituée là où les opérateurs regardent vraiment.",
